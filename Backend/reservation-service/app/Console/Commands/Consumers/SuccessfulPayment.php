...
class SuccessfulPayment extends Command
{
    private const string QUEUE_NAME = 'payments';

    protected $signature = 'payment:consume:successful-payment';

    protected $description = 'Successful payment consumer';
    ...
    private function declareQueue(AMQPChannel $channel): void
    {
        ...
        $channel->queue_bind(self::QUEUE_NAME, ExchangeName::PAYMENT, RoutingKey::PAYMENT_SUCCEEDED);
    }
}
